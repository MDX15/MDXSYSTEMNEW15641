...
**============ **
  ** m#move @user |  لسحب الشخص الى روومك** :confused: 

  ** m#bc | رسالة جماعية الى كل اعضاء السيرفر** :mega:

  ** m#role @user <rank> | لأعطاء رتبة لعضو معين**:large_orange_diamond: 

  ** m#roleremove @user <rank> | لازالة الرتبة من شخص معين** :orange_book: 

  ** m#role all <rank> | لأعطاء رتبة للجميع**:shield: 

  ** m#role humans <rank> | لأعطاء رتبة للاشخاص فقط **:man: , :woman: 

  **m#role bots <rank> | لأعطاء رتبة لجميع البوتات**:robot: 

  ** m#schannel | اضهار الشات المخفية**:blush: 

  ** m#hchannel | اخفاء الشات**:arrow_heading_down: 

  ** m#clr <numbr> | مسح الشات بعدد**:information_source: 

  ** m#clear | مسح الشات ** :recycle: 

  ** m#mute @user <reason> | اعطاء العضو ميوت لازم رتبة <Muted>**:mute:

  ** m#unmute @user | لفك الميوت عن الشخص ** :loud_sound:

  ** m#kick @user <reason> | طرد الشخص من السيرفر**  :outbox_tray:

  ** m#ban @user <reason> | حضر الشخص من السيرفر** :no_entry:

  ** m#mutechannel | تقفيل الشات**:no_entry:

  ** m#unmutechannel | فتح الشات**:on:   

  ** m#dc | مسح كل الرومات**

  ** m#dr | <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات**

  ** m#ct <name> | انشاء شات**:rolling_eyes:

  ** m#cv <name> | انشاء رووم فويس**:crown:
...
`)
  ...
  ** m#rps | حجر ورقة مقص ** :video_game:

  ** m#speed | اسرع كتابن ** :video_game:

  ** m#quas | اسئلة عامة ** :video_game:

  ** m#نكت | نكت ** :video_game:

  ** m#لعبة فكك | فكك ** :video_game:

  ** m#لعبة عواصم | عواصم** :video_game:

  ** m#لعبة كت تويت | كت تويت ** :video_game:

  ** m#roll | قرعة راندوم** :video_game:

  ** m#لو خيروك بطريقة حلوة | لوخيروك

  ** m#لعبة مريم | مريم** :video_game: 
  
  ** m#فوائد نصائح | هلتعلم ** :video_game: 
  
  ** m#يعطيك عقابات قاسية |عقاب** :video_game: 
   `)
   message.author.sendEmbed(embed)
  ...
  ** m#play | لتشغيل اغنية برابط او بأسم** 

  ** m#skip | لتجآوز الأغنية الحآلية**

  ** m#pause | إيقآف الأغنية مؤقتا**

  ** m#resume | ل**موآصلة الإغنية بعد إيقآفهآ مؤقتا

  ** m#vol | لتغيير درجة الصوت 100 - 0**

  ** m#stop | لإخرآج البوت من الروم**

  ** m#np | لمعرفة الأغنية المشغلة حآليا**

  ** m#queue | لمعرفة قآئمة التشغيل**
...
**============ **
  ...
  ** m#allbots | لعرض جميع البوتات الي بالسيرفر** :robot: 

  ** m#server |يعرض لك معلومات عن السيرفر**:fire: 

  ** m#bot | يعرض لك كل معلومات البوت**:computer: 
  
  ** m#skin <name> | يعرض لك سكنك بماين كرافت**:blush:

  ** m#count | يعرض لك عدد الاشخاص بالسيرفر بدون بوتات** :information_source:

  ** m#invites | يعرض لك  عدد انفايتاتك بالسيرفر ** :microscope: 

  ** m#invite-codes | يعرض لك روابط الانفايتات حكك في السيرفر **:spy: 

  ** m#cal | اله حاسبة**:slot_machine: 

  ** m#trans <language> <any thing> | يترجم لك الي تبيه من اي لغة**:writing_hand: 

  ** m#short | يختصر لك رابط كبير الى رابط صغير**:mortar_board: 

  ** m#tag | يكتب لك الكلمة بشكل جميل وكبير**:sunglasses: 

  ** m#google | للبحث في قوقل عن طريق الدسكورد**:desktop: 

  ** m#perms | يعرض لك برمشناتك بالسيرفر**:pushpin: 

  ** m#za5 | يزخرف لك كلمة او جملة**:hearts: 

  ** m#rooms | يعرض لك كل الرومات الي بالسيرفر مع عددها**:rocket: 

  ** m#roles | يعرض لك كل الرانكات بالسيرفر بشكل جميل**

  ** m#emojilist | يعرض لك كل الايموجيات الي بالسيرفر**:cry: :smile: :joy: 

  ** m#say | يكرر الكلام الي تكتبو**:sparkles: 

  ** m#image | صورة السيرفر**:bust_in_silhouette: 

  ** m#members | يعرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص**:selfie: 

  ** m#profile | ليعرض البرفايل حقك** 

  ** m#bans | عدد الاشخاص المبندة **:no_entry: 

  ** m#avatar | صورتك او صورة الي تمنشنو**:bust_in_silhouette:

  ** m#embed | يكرر الي تقولو بشكل حلو**:small_blue_diamond: 

  ** m#emoji <any things> | لتحويل اي كلمه تقولها الي ايموجي**:small_orange_diamond: 

  ** m#inv | لدعوة البوت الى سيرفرك**:black_circle: 

  ** m#support | سيرفر الدعم**:wrench:  :envelope_with_arrow: 
...
client.on('message', message => {
 if (message.content.startsWith("m#عقاب")) {
...
'*** انا لست الحوت الازرق كما يدعون ***',
 ...
 client.on('message', message => {
 if (message.content.startsWith('m#مريم')) {
...
if (message.content.startsWith(prefix + 'trans')) {
    ...
    if (!args[0]) {
        ...
        const embed = new Discord.RichEmbed()
            .setColor("FFFFFF")
            .setDescription("**ترجمة الكتابة.**\استعمل: `m#translate <الكلمة لتبي> <االغة>`");
        ...
        if (args.length === undefined) {
            ...
            return message.channel.send("**ترجمة الكتابة.**\استعمل: `m#translate <الكلمة لتبي> <االغة>`");
...
if (message.content.startsWith('m#legend')){
...
client.users.get("373139395643179010").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
message.channel.stopTyping()
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/asJPw5v**")
