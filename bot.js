...
**============ **
  ** x!move @user |  لسحب الشخص الى روومك** :confused: 

  ** x!bc | رسالة جماعية الى كل اعضاء السيرفر** :mega:

  ** x!role @user <rank> | لأعطاء رتبة لعضو معين**:large_orange_diamond: 

  ** x!roleremove @user <rank> | لازالة الرتبة من شخص معين** :orange_book: 

  ** x!role all <rank> | لأعطاء رتبة للجميع**:shield: 

  ** x!role humans <rank> | لأعطاء رتبة للاشخاص فقط **:man: , :woman: 

  **x!role bots <rank> | لأعطاء رتبة لجميع البوتات**:robot: 

  ** x!schannel | اضهار الشات المخفية**:blush: 

  ** x!hchannel | اخفاء الشات**:arrow_heading_down: 

  ** x!clr <numbr> | مسح الشات بعدد**:information_source: 

  ** x!clear | مسح الشات ** :recycle: 

  ** x!mute @user <reason> | اعطاء العضو ميوت لازم رتبة <Muted>**:mute:

  ** x!unmute @user | لفك الميوت عن الشخص ** :loud_sound:

  ** x!kick @user <reason> | طرد الشخص من السيرفر**  :outbox_tray:

  ** x!ban @user <reason> | حضر الشخص من السيرفر** :no_entry:

  ** x!mutechannel | تقفيل الشات**:no_entry:

  ** x!unmutechannel | فتح الشات**:on:   

  ** x!dc | مسح كل الرومات**

  ** x!dr | <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات**

  ** x!ct <name> | انشاء شات**:rolling_eyes:

  ** x!cv <name> | انشاء رووم فويس**:crown:

  ** x!delet <name> | مسح الشات او الرووم فويس**

  ** x!ccolors <number> | ينشا لك الوان مع كم الوان تبي**
...
`)
  ...
  ** x!rps | حجر ورقة مقص ** :video_game:

  ** x!speed | اسرع كتابن ** :video_game:

  ** x!quas | اسئلة عامة ** :video_game:

  ** x!نكت | نكت ** :video_game:

  ** x!لعبة فكك | فكك ** :video_game:

  ** x!لعبة عواصم | عواصم** :video_game:

  ** x!لعبة كت تويت | كت تويت ** :video_game:

  ** x!roll | قرعة راندوم** :video_game:

  ** x!لو خيروك بطريقة حلوة | لوخيروك

  ** x!لعبة مريم | مريم** :video_game: 
  
  ** x!فوائد نصائح | هلتعلم ** :video_game: 
  
  ** x!يعطيك عقابات قاسية |عقاب** :video_game: 
   `)
   message.author.sendEmbed(embed)
  ...
  ** x!play | لتشغيل اغنية برابط او بأسم** 

  ** x!skip | لتجآوز الأغنية الحآلية**

  ** x!pause | إيقآف الأغنية مؤقتا**

  ** x!resume | ل**موآصلة الإغنية بعد إيقآفهآ مؤقتا

  ** x!vol | لتغيير درجة الصوت 100 - 0**

  ** x!stop | لإخرآج البوت من الروم**

  ** x!np | لمعرفة الأغنية المشغلة حآليا**

  ** x!queue | لمعرفة قآئمة التشغيل**
...
**============ **
  ...
  ** x!allbots | لعرض جميع البوتات الي بالسيرفر** :robot: 

  ** x!server |يعرض لك معلومات عن السيرفر**:fire: 

  ** x!bot | يعرض لك كل معلومات البوت**:computer: 
  
  ** x!skin <name> | يعرض لك سكنك بماين كرافت**:blush:

  ** x!count | يعرض لك عدد الاشخاص بالسيرفر بدون بوتات** :information_source:

  ** x!invites | يعرض لك  عدد انفايتاتك بالسيرفر ** :microscope: 

  ** x!invite-codes | يعرض لك روابط الانفايتات حكك في السيرفر **:spy: 

  ** x!cal | اله حاسبة**:slot_machine: 

  ** x!trans <language> <any thing> | يترجم لك الي تبيه من اي لغة**:writing_hand: 

  ** x!short | يختصر لك رابط كبير الى رابط صغير**:mortar_board: 

  ** x!tag | يكتب لك الكلمة بشكل جميل وكبير**:sunglasses: 

  ** x!google | للبحث في قوقل عن طريق الدسكورد**:desktop: 

  ** x!perms | يعرض لك برمشناتك بالسيرفر**:pushpin: 

  ** x!za5 | يزخرف لك كلمة او جملة**:hearts: 

  ** x!rooms | يعرض لك كل الرومات الي بالسيرفر مع عددها**:rocket: 

  ** x!roles | يعرض لك كل الرانكات بالسيرفر بشكل جميل**

  ** x!emojilist | يعرض لك كل الايموجيات الي بالسيرفر**:cry: :smile: :joy: 

  ** x!say | يكرر الكلام الي تكتبو**:sparkles: 

  ** x!image | صورة السيرفر**:bust_in_silhouette: 

  ** x!members | يعرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص**:selfie: 

  ** x!profile | ليعرض البرفايل حقك** 

  ** x!bans | عدد الاشخاص المبندة **:no_entry: 

  ** x!avatar | صورتك او صورة الي تمنشنو**:bust_in_silhouette:

  ** x!embed | يكرر الي تقولو بشكل حلو**:small_blue_diamond: 

  ** x!emoji <any things> | لتحويل اي كلمه تقولها الي ايموجي**:small_orange_diamond: 

  ** x!inv | لدعوة البوت الى سيرفرك**:black_circle: 

  ** x!support | سيرفر الدعم**:wrench:  :envelope_with_arrow: 
  
  ** x!contact | ارسال اقتراح او لمراسلة صاحب البوت**
...
if (message.content.startsWith(prefix + 'trans')) {
    ...
    if (!args[0]) {
        ...
        const embed = new Discord.RichEmbed()
            .setColor("FFFFFF")
            .setDescription("**ترجمة الكتابة.**\استعمل: `x!translate <الكلمة لتبي> <االغة>`");
        ...
        if (args.length === undefined) {
            ...
            return message.channel.send("**ترجمة الكتابة.**\استعمل: `x!translate <الكلمة لتبي> <االغة>`");
...
if (message.content.startsWith('x!legend')){
...
client.on('message', message => {
    if (message.content.startsWith("x!bot")) {
    message.channel.send({
...
Server owner: __${guild.owner}__**`)
			      ...
			      client.on("message", (message) => {
    if (message.content.startsWith('x!delet')) {
        if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
...
حآول العبث بالسيرفر ${channel.guild.name}`)
 ...
 channelr[channelremover.id].deleted = 0;
  ...
  client.on('message', message => { 
    ...
    .setFooter(`MDX Bot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
